...
<head>
    ...
    <!-- CDN Download DataTables -->
    <link href="https://cdn.datatables.net/2.1.2/css/dataTables.bootstrap4.min.css" rel="stylesheet">
    <link href="https://cdn.datatables.net/buttons/3.1.0/css/buttons.bootstrap4.min.css" rel="stylesheet">
...
<body>
    ...
    <main>
        <h1 class="text-center mt-5 mb-4">APRENDICES AMT 2024</h1>
        <div class="row justify-content-center align-items-center g-2">
            <div class="col-1"></div>
            <div class="col-10">
                <a name="" id="" class="btn btn-primary mb-3" href="form_agregar.php" role="button"><i class="bi bi-person-plus-fill"></i> Agregar</a>
                        ...
                        <tbody>
                            <?php while ($aprendices = $query->fetch_object()) { ?>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a name="" id="" style="color: white;" class="btn btn-warning" href="form_editar.php?numero=<?= $aprendices->numero ?>" role="button"><i class="bi bi-pen-fill"></i> Editar</a>
